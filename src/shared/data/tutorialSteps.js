...
import { applyCreationTemplate } from '../services/projectTemplates';

export const BUILDER_TUTORIAL_TABS = ['profile', 'guided_creation', 'scenes', 'media', 'objects', 'map', 'adventure', 'hero', 'combat', 'cinematics', 'animation', 'combinations', 'enigmas', 'logic', 'ai', 'preview', 'score'];
...
export const prepareProjectForTutorial = (project, tab) => {
  ...
  if (tab === 'score' && !['expert', 'adventure', 'hero_adventure'].includes(nextProject.creationMode)) {
    nextProject.creationMode = 'expert';
  }
  if (tab === 'cinematics') {
