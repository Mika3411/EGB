...
const landingModeContent = {
  builder: {
    ...
    primaryCta: 'Créer mon premier jeu',
  ...
  demo: {
    ...
    primaryCta: 'Essayer le studio maintenant',
    ...
    final: {
      ...
      primary: 'Essayer le studio maintenant',
