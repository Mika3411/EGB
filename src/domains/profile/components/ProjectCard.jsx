...
import {
  ...
  getProjectName,
  getProjectStats,
} from '../../../shared/services/projectAnalysis';
      ...
      <div className="project-card-layout">
        ...
        <div className="project-card-body">
          ...
          <div className="project-card-footer">
            ...
            <button type="button" className="secondary-action profile-test-button" onClick={() => onTestProject?.(project.id)} data-tour="profile-project-test">
              <span aria-hidden="true">▶</span>
              Tester
            </button>
          </div>
