...
export default function ProfileMessagesPanel({ user }) {
  ...
  return (
    <section className="panel profile-messages-panel" data-tour="profile-messages-section">
      <div className="panel-head">
        ...
        <button type="button" className="secondary-action" onClick={refreshThreads} disabled={isLoading} data-tour="profile-messages-refresh">
      ...
      {threads.length ? (
        <div className="profile-messages-layout" data-tour="profile-messages-layout">
          <aside className="support-thread-list" aria-label="Conversations support" data-tour="profile-messages-list">
            {threads.map((thread) => {
          ...
          <article className="support-conversation" data-tour="profile-messages-conversation">
            ...
            <form className="support-reply-form" onSubmit={submitReply} data-tour="profile-messages-reply">
              <label>
                Répondre
                <textarea
                  value={replyDraft}
        ...
        <div className="empty-state-inline support-empty-state" data-tour="profile-messages-layout">
