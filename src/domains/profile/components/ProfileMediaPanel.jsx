...
import { getAssetStorageBytes } from '../../../shared/services/storageQuota';
import { MEDIA_FOLDERS, getAssetFolderId } from '../../../shared/services/mediaLibraryFolders';
...
export default function ProfileMediaPanel({
  projects = [],
  mediaLibrary = [],
  onImportMediaFile,
  onDeleteMedia,
  ...
  return (
    <section className="panel profile-media-panel" data-tour="profile-media-section">
      <div className="panel-head">
        <div>
          <h2>Médiathèque</h2>
          <p className="small-note">Tous les médias de tes projets, rangés par dossier et dédoublonnés.</p>
        </div>
        <div className="profile-media-stats" data-tour="profile-media-stats">
          {storageSummary ? (
      ...
      <div className="profile-media-toolbar" data-tour="profile-media-search">
        <input
          type="search"
          value={search}
      ...
      <div className="profile-storage-upgrades" aria-label="Augmenter le stockage" data-tour="profile-storage-upgrades">
      ...
      <div className="profile-media-browser" data-tour="profile-media-browser">
        <aside className="profile-media-sidebar" aria-label="Dossiers par projet" data-tour="profile-media-folders">
        ...
        {visibleMedia.length ? (
          <div className="profile-media-results" data-tour="profile-media-results">
          <div className="profile-media-grid" data-tour="profile-media-grid">
          ...
          <div className="empty-state-inline" data-tour="profile-media-grid">
            <div>
