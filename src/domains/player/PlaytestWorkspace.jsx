...
export default function PlaytestWorkspace(props) {
  const {
    playScene, viewerImage, setViewerImage, playingCinematic, playingSlideIndex, currentSlide, setPlayingSlideIndex,
    closeCinematic, advanceCinematic, audioRef, onSceneTimerEnd, triggerHotspot, resetPreview, saveGameState, loadGameState,
    restoreLastChoiceSnapshot, getSceneLabel, dialogue, inventory, visitedSceneIds = [], storyVariables = {},
    adventureJournalEntries = [], chosenConversationReplyIds = [], hiddenConversationReplyIds = [], completedHotspotIds = [],
    addInventoryItem, removeInventoryItem, playerLives = 3, heroAdventure = { enabled: false }, heroState = null,
    heroSetupComplete = true, activeHeroCombat = null, heroCombatStates = {}, attackActiveHeroCombat, rollActiveEnemyCombat,
    attemptSurvivalHeroCombat, attemptEscapeHeroCombat, closeHeroCombat, equippedHeroItemIds = [], equippedHeroSlotMap = {},
    lastChoiceSnapshot = null, adjustHeroStat, lastDiceRoll, rollHeroDie, selectHeroCharacter, rollHeroSetupSkills, completeHeroSetup,
    sceneTimerResetKey = 0, setInventory, setSelectedInventoryIds, usedSceneObjectIds = [], revealedSceneObjectIds = [],
    sceneObjectTextOverrides = {}, markSceneObjectUsed, markHotspotCompleted, project, selectedInventoryIds, openInventoryItem,
    equipHeroItem, unequipHeroItem, setDraggedInventoryId, draggedInventoryId, combineInventoryItems, setDialogue, activeEnigma,
    activeConversation, activeEnding, choiceEffectNotices = [], closeConversation, closeEnding, clearChoiceEffectNotices,
    isConversationReplyAvailable, getConversationReplyLockReason, chooseConversationReply, heroCharacterPreviewRequestKey = 0,
