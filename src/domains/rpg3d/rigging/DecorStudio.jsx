...
import { makeDecor3DModel } from '../../../shared/data/projectData';
import {
...
const Decor3DPreview = lazyWithRetry(() => import('../components/Decor3DPreview.jsx'));
...
export default function DecorStudio({
  ...
  const setSelectedModelFile = useCallback(async (file) => {
    ...
    try {
      const { readDecorModelImport } = await import('../../../shared/utils/rpg3dModelImport');
      const {
        zipBundle,
        sourceFile,
        sourceFormat,
