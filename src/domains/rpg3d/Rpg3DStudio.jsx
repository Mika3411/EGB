...
import Rpg3DHeader from './components/Rpg3DHeader.jsx';
import Rpg3DInspector from './components/Rpg3DInspector.jsx';
import Rpg3DMapPanel from './components/Rpg3DMapPanel.jsx';
import Rpg3DNpcChoiceOverlay from './components/Rpg3DNpcChoiceOverlay.jsx';
import Rpg3DStage from './components/Rpg3DStage.jsx';
import ArcadeCanvasManagerPanel from './components/ArcadeCanvasManagerPanel.jsx';
import ArcadeHeroPanel from './components/ArcadeHeroPanel.jsx';
import ArcadeManagementPanel from './components/ArcadeManagementPanel.jsx';
import ArcadeMapAssetExplorer from './components/ArcadeMapAssetExplorer.jsx';
import Rpg3DWorkspaceNav from './components/Rpg3DWorkspaceNav.jsx';
...
import { lazyWithRetry } from '../../shared/utils/lazyImportRetry.js';
import {
...
} from './components/rpg3dModeShared.js';

const CharacterStudio = lazyWithRetry(() => import('../characters/CharacterStudio.jsx'));
const CharacterRiggingWorkspace = lazyWithRetry(() => import('../characters/rigging/CharacterRiggingWorkspace.jsx'));
const DecorStudio = lazyWithRetry(() => import('./rigging/DecorStudio.jsx'));
const ModelToolsWorkspace = lazyWithRetry(() => import('./model-tools/ModelToolsWorkspace.jsx'));
const ObjectRiggingWorkspace = lazyWithRetry(() => import('./rigging/ObjectRiggingWorkspace.jsx'));
const StuntAnimationWorkspace = lazyWithRetry(() => import('./stunts/StuntAnimationWorkspace.jsx'));

function Rpg3DStudio({ user = null, authorProfile = null, authReady = true, project = null, projectId = '' }) {
