...
import { getCreatorMissionProgress } from '../../shared/data/creatorMissions';
import HelpContent, { parseHelpSections } from './components/HelpContent.jsx';
import {
  canUseSupabaseForum,
...
} from '../../shared/services/forumStorage';
...
} from './components/helpCenterData.js';
...
export default function HelpCenter({ user, project = null, projectRecord = null, projectMode = 'expert', onStartTutorial }) {
