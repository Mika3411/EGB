...
export default function ProjectScoreDashboard({ project }) {
  ...
  return (
    <div className="layout score-layout">
      <section className="panel score-hero-panel" data-tour="score-overview">
        ...
        <div className="score-section-grid" data-tour="score-section-breakdown">
          <div>
      ...
      <section className="panel score-inventory-panel" data-tour="score-inventory">
        ...
        <div className="score-connection-summary" data-tour="score-connection-summary">
        ...
        <div className="score-playtime-card" data-tour="score-playtime">
