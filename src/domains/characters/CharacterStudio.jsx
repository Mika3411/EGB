...
import { makeCharacter3DModel } from '../../shared/data/projectData';
import {
...
} from '../../shared/utils/rpg3dModelImportCore.js';
import {
  THREE_MODEL_ACCEPT,
  getThreeModelFormatLabel,
  getThreeModelSource,
} from '../../shared/utils/threeModelUtils.js';
import {
...
import { getStudioDecorKindId } from '../../shared/utils/rpg3dDomain.js';
import { formatBytes } from '../../shared/utils/glbOptimizer';
import { lazyWithRetry } from '../../shared/utils/lazyImportRetry';
import { getAdminAuthHeaders } from '../../shared/services/adminApi';
import HelpLabel from '../../shared/ui/forms/HelpLabel.jsx';

const Character3DPreview = lazyWithRetry(() => import('./preview/Character3DPreview.jsx'));
...
export default function CharacterStudio({
  ...
  const setSelectedModelFile = useCallback(async (file) => {
    ...
    try {
      ...
      const { readCharacterModelImport } = await import('../../shared/utils/rpg3dModelImport');
      const {
        zipBundle,
        sourceFormat,
        isGlb,
  ...
  const setSelectedAnimationFile = useCallback(async (slot, file, requestedAnimationKey = '') => {
    ...
    try {
      ...
      const { readCharacterAnimationImport } = await import('../../shared/utils/rpg3dModelImport');
      const {
        zipBundle,
        sourceFile,
        sourceFormat,
