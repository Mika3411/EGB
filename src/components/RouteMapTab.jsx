...
const getDefaultMap = () => ({ rows: 16, cols: 24, cells: [], rooms: [], connections: [], canvases: getDefaultCanvases(), notes: '' });
const FIELD_HELP = {
...
const getRouteSceneTransitions = (project) => (
...
const getConnectionNarrativeBadges = (project, fromRoom, toRoom) => {
...
const getNarrativePlan = (project, actId, getSceneLabel) => {
