...
export const getTutorialTarget = (step) => {
  ...
  for (const selector of selectors) {
    ...
    if (target instanceof HTMLElement) {
      const parentTabMenu = target.closest('details.tabs-menu');
      if (parentTabMenu instanceof HTMLElement) parentTabMenu.open = true;
      return target;
    }
  }
  return null;
...
export default function BuilderGuide({ step, stepNumber, totalSteps, canPrevious, userName, project, fakeFileOptions, onFakeFileChosen, onNext, onPrevious, onClose }) {
