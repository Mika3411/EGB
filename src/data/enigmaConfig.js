...
export const FIELD_HELP = {
  list: "Liste des énigmes du projet. Sélectionne une énigme pour modifier sa question, sa solution et ce qu’elle débloqué.",
  ...
  solution: "Réponse exacte attendue pour les énigmes de code. Tu peux utiliser des chiffres, des lettrès ou un mélange court.",
  ...
  miscTargetItem: "Objet que le joueur doit selectionner pour valider l’énigme.",
  ...
  gridCols: "Nombre de colonnes du découpage. Plus il y en a, plus le joueur manipule dé pièces.",
  ...
  unlockType: "Action déclénchée après réussite: simplement valider l’énigme, ouvrir une scène ou lancer une cinématique.",
