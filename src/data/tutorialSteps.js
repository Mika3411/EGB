...
export const BUILDER_TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    title: 'Didacticiels',
    body: 'Ce menu contient les parcours d apprentissage. Tu peux choisir Profil, Scenes, Editeur, Plan, Cinematiques, Animation, Combinaisons, Enigmes, Logique ou IA selon ce que tu veux apprendre.',
  ...
  makeTutorialEndStep('cinematics', '[data-tour="cinematic-end-settings"]'),
  {
    ...
    body: 'Ici, {name}, tu composes une courte sequence 2D : des images posees en calques, un storyboard pour le rythme, puis une previsualisation pour voir le rendu comme une mini-cinematique.',
    action: 'Clique dans l editeur Animation pour commencer le tour.',
    completeWhen: { type: 'interact' },
  },
  {
    tab: 'animation',
    ...
    action: 'Clique dans la barre du haut pour la reperer.',
    completeWhen: { type: 'interact' },
  },
  {
    tab: 'animation',
    ...
    body: 'Fichier gere les imports et exports, Editer manipule les calques, Affichage controle la vue, Image sert aux retouches, et Animation applique les mouvements comme Respiration, Apparition ou Aura.',
  ...
  },
  {
    ...
    body: 'Ce bouton remet l animation a zero. Il affiche un avertissement avant de supprimer le brouillon en cours, donc tu peux repartir proprement sans mauvaise surprise.',
  ...
  },
  {
    ...
    title: 'Storyboard',
    body: 'Le storyboard decrit la sequence dans le temps. Chaque etape choisit quand quelque chose arrive : continuer la scene, afficher une image, remplacer une image, et ajouter une narration.',
  ...
  },
  {
    ...
    body: 'Une etape ajoute un nouveau moment sur la timeline. Utilise-la pour faire apparaitre un personnage, reveler un indice ou changer l image au bon instant.',
    action: 'Clique sur Ajouter une etape pour voir une nouvelle ligne dans le storyboard.',
    completeWhen: { type: 'interact' },
    autoNext: true,
  },
  {
    ...
    action: 'Clique une etape de la liste.',
    completeWhen: { type: 'interact' },
  },
  {
    tab: 'animation',
    ...
    title: 'Action image',
    body: 'Ce choix decide ce que l etape fait aux images : continuer la scene, afficher un nouveau calque ou remplacer l image visible. C est le reglage qui donne le rythme visuel.',
  ...
  },
  {
    ...
    title: 'Narration',
    body: 'La narration accompagne l etape. Garde-la courte, comme une phrase de mise en scene : elle doit soutenir l image sans ralentir la sequence.',
    action: 'Ecris une phrase d au moins 8 caracteres.',
    completeWhen: { type: 'input-min', selector: '[data-tour="anime-step-narration"] textarea', min: 8 },
  },
  {
    tab: 'animation',
  ...
  },
  {
    ...
    action: 'Clique dans les controles du canvas.',
    completeWhen: { type: 'interact' },
  },
  {
    tab: 'animation',
  ...
  },
  {
    ...
    title: 'Timeline',
    body: 'La timeline donne une vue rapide des durees et delais. Elle aide a voir si une animation commence trop tot, dure trop longtemps ou se superpose mal aux autres.',
  ...
  },
  {
    ...
    title: 'Inspecteur',
    body: 'L inspecteur regle le calque selectionne : nom, position, taille, opacite, duree, delai, boucle et ordre. C est la zone des ajustements precis.',
  ...
  },
  {
    ...
    body: 'Le verrouillage protege un calque termine. C est tres utile pour un fond ou un personnage deja bien place : tu continues a travailler autour sans le bouger par erreur.',
  ...
  },
  {
    ...
    body: 'X et Y placent le centre, Taille controle l echelle, Opacite gere la transparence. Duree et Delai reglent la sensation du mouvement applique au calque.',
  ...
  },
  {
    ...
    body: 'La boucle repete le preset en continu. Active-la pour une respiration, une aura ou un flottement. Desactive-la pour une apparition ponctuelle.',
  ...
  },
  {
    ...
    body: 'Sauvegarder garde ta composition dans le projet et sur cet appareil quand c est possible. Prends l habitude de le faire apres une bonne version.',
  ...
  },
  {
    ...
    title: 'Previsualiser',
    body: 'Previsualiser lance la sequence comme un lecteur. C est le dernier controle : rythme, narration, ordre des calques, lisibilite et mouvements.',
